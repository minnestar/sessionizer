class Category < ActiveRecord::Base
  ...
  NEW_DEFAULTS = [
    ...
    { name: "Soft Skills", long_name: "Soft Skills & Personal Growth", tagline: "Be a better leader, teammate, and human.", description: "Leadership, team culture, burnout, mental health, productivity, work-life balance, people management, and personal development.", default_position: 8 },
