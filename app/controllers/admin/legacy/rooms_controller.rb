class Admin::Legacy::RoomsController < Admin::Legacy::AdminController
  ...
  def update
    if @room.update room_params
      redirect_to admin_legacy_event_path(@room.event_id)
    else
      render :edit
    end
  end
  ...
  def create
    ...
    if @room.save
      redirect_to admin_legacy_event_path(@event)
    else
      render :new
    end
  end
