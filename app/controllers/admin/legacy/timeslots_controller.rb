class Admin::Legacy::TimeslotsController < Admin::Legacy::AdminController
  ...
  def update
    if @timeslot.update timeslot_params
      redirect_to admin_legacy_event_timeslots_path(event_id: @timeslot.event_id)
    else
      render :edit
    end
  end
  ...
  def create
    ...
    if @timeslot.save
      redirect_to admin_legacy_event_timeslots_path
    else
      render :new
    end
  end
