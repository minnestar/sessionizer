...
describe Session do
  ...
  it 'should allow rooms and time slots to be swapped' do
    ...
    assert_equal(session1.room, room1)
    assert_equal(session1.timeslot, slot1)
    assert_equal(session2.room, room2)
    assert_equal(session2.timeslot, slot2)
    Session.swap_timeslot_and_rooms(session1, session2)
    assert_equal(session1.room, room2)
    assert_equal(session1.timeslot, slot2)
    assert_equal(session2.room, room1)
